      ...
      <SidebarContext.Provider value={ contextValue }>
        <TooltipProvider delayDuration={ 0 }>
          <div
            ...
            className={ cn(
              "group/sidebar-wrapper flex min-h-svh sm:w-full has-[[data-variant=inset]]:bg-sidebar",
              className
            ) }
            ref={ ref }
            { ...props }
...
//I customized the  'hover:text-sidebar-accent-foreground' to 'hover:text-white'
